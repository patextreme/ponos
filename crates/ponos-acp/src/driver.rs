...
use ponos_core::ports::{
    AgentTransport, BridgeConfig, EventSink, HeadlessPolicy, InteractionPolicy,
};
use ponos_core::session::{
    SessionCmd, SessionError, SessionHandle, SessionOptions, TurnError, TurnOutcome, UsageCounts,
};
use ponos_core::turn::{PeekInputs, TurnFold, status_string, submission_sink};
use ponos_result::{bind_result_socket, spawn_result_channel};
...
pub async fn start_session(
    ...
    let mut result_channel: Option<ponos_result::ResultChannel> = None;
