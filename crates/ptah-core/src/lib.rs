...
/// The ptah version string, surfaced by the CLI (`--version`, the
/// `ptah types` header) and the `ptah.version` script binding. Lives
/// here — not in `ptah-cli` — because both the CLI crate and the
