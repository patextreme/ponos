...
//! consumes. The [`AgentTransport`](crate::core::ports::AgentTransport)
...
impl UsageCounts {
    pub(crate) fn from_usage(u: &Usage) -> Self {
        Self {
...
pub struct SessionHandle {
    ...
    /// the lock).
    pub(crate) turn_lock: Arc<tokio::sync::Mutex<()>>,
    ...
    pub(crate) config_options: Arc<Mutex<Vec<SessionConfigOption>>>,
}
